...
public abstract class BaseCmsSiteFlow  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.cms.entity.assist.CmsSiteFlow)) return false;
		else {
			com.jetcms.cms.entity.assist.CmsSiteFlow cmsSiteFlow = (com.jetcms.cms.entity.assist.CmsSiteFlow) obj;
