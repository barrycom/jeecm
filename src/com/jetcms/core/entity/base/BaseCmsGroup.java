...
public abstract class BaseCmsGroup  implements Serializable {
	...
	// collections
	private java.util.Set<com.jetcms.cms.entity.main.Channel> viewChannels;
	private java.util.Set<com.jetcms.cms.entity.main.Channel> contriChannels;
	 ...
	 */
	public java.util.Set<com.jetcms.cms.entity.main.Channel> getViewChannels () {
		return viewChannels;
	}
	 ...
	 */
	public void setViewChannels (java.util.Set<com.jetcms.cms.entity.main.Channel> viewChannels) {
	 ...
	 */
	public java.util.Set<com.jetcms.cms.entity.main.Channel> getContriChannels () {
	 ...
	 */
	public void setContriChannels (java.util.Set<com.jetcms.cms.entity.main.Channel> contriChannels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.core.entity.CmsGroup)) return false;
		else {
			com.jetcms.core.entity.CmsGroup cmsGroup = (com.jetcms.core.entity.CmsGroup) obj;
