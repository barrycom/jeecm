...
public abstract class BaseCmsVoteTopic  implements Serializable {
	...
	// collections
	private java.util.Set<com.jetcms.cms.entity.assist.CmsVoteItem> items;
	private java.util.Set<com.jetcms.cms.entity.assist.CmsVoteSubTopic> subtopics;
	private java.util.Set<com.jetcms.cms.entity.assist.CmsVoteRecord> records;
	 ...
	 */
	public java.util.Set<com.jetcms.cms.entity.assist.CmsVoteItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.jetcms.cms.entity.assist.CmsVoteItem> items) {
		this.items = items;
	}

	public java.util.Set<com.jetcms.cms.entity.assist.CmsVoteSubTopic> getSubtopics() {
		return subtopics;
	}

	public void setSubtopics(
			java.util.Set<com.jetcms.cms.entity.assist.CmsVoteSubTopic> subtopics) {
		this.subtopics = subtopics;
	}

	public java.util.Set<com.jetcms.cms.entity.assist.CmsVoteRecord> getRecords() {
		return records;
	}

	public void setRecords(
			java.util.Set<com.jetcms.cms.entity.assist.CmsVoteRecord> records) {
		this.records = records;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.jetcms.cms.entity.assist.CmsVoteTopic)) return false;
		else {
			com.jetcms.cms.entity.assist.CmsVoteTopic cmsVoteTopic = (com.jetcms.cms.entity.assist.CmsVoteTopic) obj;
