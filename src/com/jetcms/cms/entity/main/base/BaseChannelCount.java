...
public abstract class BaseChannelCount  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.cms.entity.main.ChannelCount)) return false;
		else {
			com.jetcms.cms.entity.main.ChannelCount channelCount = (com.jetcms.cms.entity.main.ChannelCount) obj;
