...
public abstract class BaseCmsVoteItem  implements Serializable {
	...
	public BaseCmsVoteItem (
		Integer id,
		com.jetcms.cms.entity.assist.CmsVoteTopic topic,
		String title,
		Integer voteCount,
		Integer priority) {
	...
	// many to one
	private com.jetcms.cms.entity.assist.CmsVoteTopic topic;
	private com.jetcms.cms.entity.assist.CmsVoteSubTopic subTopic;
	 ...
	 */
	public com.jetcms.cms.entity.assist.CmsVoteTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (com.jetcms.cms.entity.assist.CmsVoteTopic topic) {
		this.topic = topic;
	}
	

	public com.jetcms.cms.entity.assist.CmsVoteSubTopic getSubTopic() {
		return subTopic;
	}

	public void setSubTopic(com.jetcms.cms.entity.assist.CmsVoteSubTopic subTopic) {
		this.subTopic = subTopic;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.jetcms.cms.entity.assist.CmsVoteItem)) return false;
		else {
			com.jetcms.cms.entity.assist.CmsVoteItem cmsVoteItem = (com.jetcms.cms.entity.assist.CmsVoteItem) obj;
