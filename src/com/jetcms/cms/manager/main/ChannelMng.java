...
public interface ChannelMng {
	...
	public List<Channel> getChildListByRightByuserId(Integer userId, Integer siteId, Integer parentId, boolean hasContentOnly);
	...
	public Channel save(Channel bean, ChannelExt ext, ChannelTxt txt,
                        ...
                        Integer[] userIds, Integer siteId, Integer parentId,
                        Integer modelId, Integer workflowId, Integer[] modelIds, String[] tpls, String[] mtpls,
                        String[] catalogNames, String[] cataloglectureDates, String[] catalogstartTimes, String[] catalogendTimes,
                        String[] catalogpaths, Integer[] viewCounts, String[] courseCategorys, String[] isFixeds);
