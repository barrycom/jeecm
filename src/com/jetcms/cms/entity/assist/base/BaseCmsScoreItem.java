...
public abstract class BaseCmsScoreItem  implements Serializable {
	...
	public BaseCmsScoreItem (
		Integer id,
		com.jetcms.cms.entity.assist.CmsScoreGroup group,
		String name,
		Integer score,
		Integer priority) {
	...
	// many to one
	private com.jetcms.cms.entity.assist.CmsScoreGroup group;

	// collections
	private java.util.Set<com.jetcms.cms.entity.assist.CmsScoreRecord> records;
	 ...
	 */
	public com.jetcms.cms.entity.assist.CmsScoreGroup getGroup () {
		return group;
	}
	 ...
	 */
	public void setGroup (com.jetcms.cms.entity.assist.CmsScoreGroup group) {
		this.group = group;
	}
	 ...
	 */
	public java.util.Set<com.jetcms.cms.entity.assist.CmsScoreRecord> getRecords () {
		return records;
	}
	 ...
	 */
	public void setRecords (java.util.Set<com.jetcms.cms.entity.assist.CmsScoreRecord> records) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.cms.entity.assist.CmsScoreItem)) return false;
		else {
			com.jetcms.cms.entity.assist.CmsScoreItem cmsScoreItem = (com.jetcms.cms.entity.assist.CmsScoreItem) obj;
