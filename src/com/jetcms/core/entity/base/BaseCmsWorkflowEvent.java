...
public abstract class BaseCmsWorkflowEvent  implements Serializable {
	 ...
	 */
	public BaseCmsWorkflowEvent (Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public BaseCmsWorkflowEvent (
		Integer id,
		com.jetcms.core.entity.CmsWorkflow workFlow,
		com.jetcms.core.entity.CmsUser initiator,
		Integer dateId,
	...
	private com.jetcms.core.entity.CmsUser initiator;

	// collections
	private java.util.Set<com.jetcms.core.entity.CmsWorkflowRecord> records;
	private java.util.Set<com.jetcms.core.entity.CmsWorkflowEventUser> users;
	 ...
	 */
	public com.jetcms.core.entity.CmsUser getInitiator () {
		return initiator;
	}
	 ...
	 */
	public void setInitiator (com.jetcms.core.entity.CmsUser initiator) {
	 ...
	 */
	public java.util.Set<com.jetcms.core.entity.CmsWorkflowRecord> getRecords () {
		return records;
	}
	 ...
	 */
	public void setRecords (java.util.Set<com.jetcms.core.entity.CmsWorkflowRecord> records) {
	 ...
	 */
	public java.util.Set<com.jetcms.core.entity.CmsWorkflowEventUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.jetcms.core.entity.CmsWorkflowEventUser> users) {
		this.users = users;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.core.entity.CmsWorkflowEvent)) return false;
		else {
			com.jetcms.core.entity.CmsWorkflowEvent cmsWorkflowEvent = (com.jetcms.core.entity.CmsWorkflowEvent) obj;
