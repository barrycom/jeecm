...
public abstract class BaseCmsWebserviceCallRecord  implements Serializable {
	...
	// many to one
	private com.jetcms.cms.entity.assist.CmsWebserviceAuth auth;
	 ...
	 */
	public com.jetcms.cms.entity.assist.CmsWebserviceAuth getAuth () {
		return auth;
	}
	 ...
	 */
	public void setAuth (com.jetcms.cms.entity.assist.CmsWebserviceAuth auth) {
		this.auth = auth;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.cms.entity.assist.CmsWebserviceCallRecord)) return false;
		else {
			com.jetcms.cms.entity.assist.CmsWebserviceCallRecord cmsWebserviceCallRecord = (com.jetcms.cms.entity.assist.CmsWebserviceCallRecord) obj;
