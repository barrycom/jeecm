...
public abstract class BaseContentCount  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.cms.entity.main.ContentCount)) return false;
		else {
			com.jetcms.cms.entity.main.ContentCount contentCount = (com.jetcms.cms.entity.main.ContentCount) obj;
