...
public abstract class BaseCmsScoreGroup  implements Serializable {
	...
	// collections
	private java.util.Set<com.jetcms.cms.entity.assist.CmsScoreItem> items;
	 ...
	 */
	public java.util.Set<com.jetcms.cms.entity.assist.CmsScoreItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.jetcms.cms.entity.assist.CmsScoreItem> items) {
		this.items = items;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.cms.entity.assist.CmsScoreGroup)) return false;
		else {
			com.jetcms.cms.entity.assist.CmsScoreGroup cmsScoreGroup = (com.jetcms.cms.entity.assist.CmsScoreGroup) obj;
