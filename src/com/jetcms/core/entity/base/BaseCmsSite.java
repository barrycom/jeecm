...
public abstract class BaseCmsSite  implements Serializable {
	...
	public BaseCmsSite (
		Integer id,
		com.jetcms.core.entity.CmsConfig config,
		String domain,
		String path,
		String name,
		String protocol,
	...
	// many to one
	private com.jetcms.core.entity.Ftp uploadFtp;
	private com.jetcms.core.entity.Ftp syncPageFtp;
	private com.jetcms.core.entity.CmsConfig config;
	// one to one
	private com.jetcms.core.entity.CmsSiteCompany siteCompany;
	private com.jetcms.core.entity.CmsSite parent;
	...
	private java.util.Set<com.jetcms.cms.entity.assist.CmsSiteAccessCount> accessCounts;
	private java.util.Set<com.jetcms.cms.entity.assist.CmsSiteAccess> accesses;
	private java.util.Set<com.jetcms.cms.entity.assist.CmsSiteAccessPages> accessPages;
	private java.util.Set<com.jetcms.cms.entity.assist.CmsSiteAccessStatistic> accessStatistics;
	 ...
	 */
	public com.jetcms.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (com.jetcms.core.entity.Ftp uploadFtp) {
		this.uploadFtp = uploadFtp;
	}

	public com.jetcms.core.entity.Ftp getSyncPageFtp() {
		return syncPageFtp;
	}

	public void setSyncPageFtp(com.jetcms.core.entity.Ftp syncPageFtp) {
	 ...
	 */
	public com.jetcms.core.entity.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.jetcms.core.entity.CmsConfig config) {
		this.config = config;
	}
	
	public com.jetcms.core.entity.CmsSiteCompany getSiteCompany() {
		return siteCompany;
	}

	public void setSiteCompany(com.jetcms.core.entity.CmsSiteCompany siteCompany) {
		this.siteCompany = siteCompany;
	}

	public com.jetcms.core.entity.CmsSite getParent() {
		return parent;
	}

	public void setParent(com.jetcms.core.entity.CmsSite parent) {
		this.parent = parent;
	}
	...
	public void setUserSites(
			java.util.Set<com.jetcms.core.entity.CmsUserSite> userSites) {
	...
	public java.util.Set<com.jetcms.cms.entity.assist.CmsSiteAccessCount> getAccessCounts() {
		return accessCounts;
	}

	public void setAccessCounts(
			java.util.Set<com.jetcms.cms.entity.assist.CmsSiteAccessCount> accessCounts) {
		this.accessCounts = accessCounts;
	}

	public java.util.Set<com.jetcms.cms.entity.assist.CmsSiteAccess> getAccesses() {
		return accesses;
	}

	public void setAccesses(
			java.util.Set<com.jetcms.cms.entity.assist.CmsSiteAccess> accesses) {
		this.accesses = accesses;
	}

	public java.util.Set<com.jetcms.cms.entity.assist.CmsSiteAccessPages> getAccessPages() {
		return accessPages;
	}

	public void setAccessPages(
			java.util.Set<com.jetcms.cms.entity.assist.CmsSiteAccessPages> accessPages) {
		this.accessPages = accessPages;
	}

	public java.util.Set<com.jetcms.cms.entity.assist.CmsSiteAccessStatistic> getAccessStatistics() {
		return accessStatistics;
	}

	public void setAccessStatistics(
			java.util.Set<com.jetcms.cms.entity.assist.CmsSiteAccessStatistic> accessStatistics) {
		this.accessStatistics = accessStatistics;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.jetcms.core.entity.CmsSite)) return false;
		else {
			com.jetcms.core.entity.CmsSite cmsSite = (com.jetcms.core.entity.CmsSite) obj;
