...
public abstract class BaseCmsWebserviceAuth  implements Serializable {
	...
	// collections
	private java.util.Set<com.jetcms.cms.entity.assist.CmsWebserviceCallRecord> webserviceCallRecords;
	 ...
	 */
	public java.util.Set<com.jetcms.cms.entity.assist.CmsWebserviceCallRecord> getWebserviceCallRecords () {
	 ...
	 */
	public void setWebserviceCallRecords (java.util.Set<com.jetcms.cms.entity.assist.CmsWebserviceCallRecord> webserviceCallRecords) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.cms.entity.assist.CmsWebserviceAuth)) return false;
		else {
			com.jetcms.cms.entity.assist.CmsWebserviceAuth cmsWebserviceAuth = (com.jetcms.cms.entity.assist.CmsWebserviceAuth) obj;
