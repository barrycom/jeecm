...
public abstract class BaseCmsAccountPay  implements Serializable {
	...
	// many to one
	private com.jetcms.core.entity.CmsUser payUser;
	 ...
	 */
	public com.jetcms.core.entity.CmsUser getPayUser () {
		return payUser;
	}
	 ...
	 */
	public void setPayUser (com.jetcms.core.entity.CmsUser payUser) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.cms.entity.assist.CmsAccountPay)) return false;
		else {
			com.jetcms.cms.entity.assist.CmsAccountPay cmsAccountPay = (com.jetcms.cms.entity.assist.CmsAccountPay) obj;
