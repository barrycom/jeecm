...
public abstract class BaseCmsUserSite  implements Serializable {
	...
	public Boolean getAllChannelControl() {
		return allChannelControl;
	}

	public void setAllChannelControl(Boolean allChannelControl) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.core.entity.CmsUserSite)) return false;
		else {
			com.jetcms.core.entity.CmsUserSite cmsUserSite = (com.jetcms.core.entity.CmsUserSite) obj;
