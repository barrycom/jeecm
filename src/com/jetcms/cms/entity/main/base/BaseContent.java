...
public abstract class BaseContent  implements Serializable {
	...
	// one to one
	private com.jetcms.cms.entity.main.ContentExt contentExt;
	private com.jetcms.cms.entity.main.ContentCount contentCount;

	// many to one
	private com.jetcms.cms.entity.main.ContentType type;
	...
	private java.util.Set<com.jetcms.cms.entity.main.CmsTopic> topics;
	private java.util.Set<com.jetcms.core.entity.CmsGroup> viewGroups;
	private java.util.List<com.jetcms.cms.entity.main.ContentTag> tags;
	private java.util.List<com.jetcms.cms.entity.main.ContentPicture> pictures;
	private java.util.List<com.jetcms.cms.entity.main.ContentAttachment> attachments;
	
	private java.util.List<com.jetcms.cms.entity.main.ContentCatalog> catalog;
	private java.util.List<com.jetcms.cms.entity.main.ContentKj> kj;
	private java.util.Set<com.jetcms.cms.entity.main.ContentTxt> contentTxtSet;
	private java.util.Set<com.jetcms.cms.entity.main.ContentCheck> contentCheckSet;
	private java.util.Set<com.jetcms.cms.entity.main.ContentDoc> contentDocSet;
	private java.util.Set<com.jetcms.cms.entity.main.ContentCharge> contentChargeSet;
	private java.util.Set<com.jetcms.cms.entity.main.ContentBuy> contentBuySet;
	private java.util.Set<com.jetcms.core.entity.CmsWorkflowEvent> eventSet;
	...
	private java.util.Set<com.jetcms.core.entity.CmsUser> collectUsers;
	private java.util.Set<com.jetcms.cms.entity.assist.CmsComment> comments;
	private java.util.Set<com.jetcms.cms.entity.assist.CmsFile> files;
	private java.util.Set<com.jetcms.cms.entity.assist.CmsJobApply> jobApplys;
	private java.util.Set<com.jetcms.cms.entity.assist.CmsScoreRecord> scoreRecordSet;
	...
	public java.util.Set<com.jetcms.cms.entity.assist.CmsFile> getFiles() {
		return files;
	}

	public void setFiles(java.util.Set<com.jetcms.cms.entity.assist.CmsFile> files) {
		this.files = files;
	}
	...
	public java.util.Set<com.jetcms.cms.entity.assist.CmsScoreRecord> getScoreRecordSet() {
		return scoreRecordSet;
	}

	public void setScoreRecordSet(
			java.util.Set<com.jetcms.cms.entity.assist.CmsScoreRecord> scoreRecordSet) {
	 ...
	 */
	public com.jetcms.cms.entity.main.ContentExt getContentExt () {
		return contentExt;
	}
	 ...
	 */
	public void setContentExt (com.jetcms.cms.entity.main.ContentExt contentExt) {
	 ...
	 */
	public com.jetcms.cms.entity.main.ContentCount getContentCount () {
		return contentCount;
	}
	 ...
	 */
	public void setContentCount (com.jetcms.cms.entity.main.ContentCount contentCount) {
	 ...
	 */
	public com.jetcms.cms.entity.main.ContentType getType () {
		return type;
	}
	 ...
	 */
	public void setType (com.jetcms.cms.entity.main.ContentType type) {
		this.type = type;
	}
	 ...
	 */
	public java.util.Set<com.jetcms.cms.entity.main.CmsTopic> getTopics () {
		return topics;
	}
	 ...
	 */
	public void setTopics (java.util.Set<com.jetcms.cms.entity.main.CmsTopic> topics) {
		this.topics = topics;
	}
	 ...
	 */
	public java.util.List<com.jetcms.cms.entity.main.ContentTag> getTags () {
		return tags;
	}
	 ...
	 */
	public void setTags (java.util.List<com.jetcms.cms.entity.main.ContentTag> tags) {
		this.tags = tags;
	}
	 ...
	 */
	public java.util.List<com.jetcms.cms.entity.main.ContentPicture> getPictures () {
		return pictures;
	}
	 ...
	 */
	public void setPictures (java.util.List<com.jetcms.cms.entity.main.ContentPicture> pictures) {
	 ...
	 */
	public java.util.List<com.jetcms.cms.entity.main.ContentAttachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.List<com.jetcms.cms.entity.main.ContentAttachment> attachments) {
	 ...
	 */
	public java.util.Set<com.jetcms.cms.entity.main.ContentTxt> getContentTxtSet () {
	 ...
	 */
	public void setContentTxtSet (java.util.Set<com.jetcms.cms.entity.main.ContentTxt> contentTxtSet) {
	 ...
	 */
	public java.util.Set<com.jetcms.cms.entity.main.ContentCheck> getContentCheckSet () {
	 ...
	 */
	public void setContentCheckSet (java.util.Set<com.jetcms.cms.entity.main.ContentCheck> contentCheckSet) {
		this.contentCheckSet = contentCheckSet;
	}

	public java.util.Set<com.jetcms.cms.entity.main.ContentDoc> getContentDocSet() {
		return contentDocSet;
	}

	public void setContentDocSet(
			java.util.Set<com.jetcms.cms.entity.main.ContentDoc> contentDocSet) {
		this.contentDocSet = contentDocSet;
	}
	
	public java.util.Set<com.jetcms.cms.entity.main.ContentCharge> getContentChargeSet() {
		return contentChargeSet;
	}

	public void setContentChargeSet(java.util.Set<com.jetcms.cms.entity.main.ContentCharge> contentChargeSet) {
		this.contentChargeSet = contentChargeSet;
	}

	public java.util.Set<com.jetcms.cms.entity.main.ContentBuy> getContentBuySet() {
		return contentBuySet;
	}

	public void setContentBuySet(java.util.Set<com.jetcms.cms.entity.main.ContentBuy> contentBuySet) {
		this.contentBuySet = contentBuySet;
	}

	public java.util.Set<com.jetcms.core.entity.CmsWorkflowEvent> getEventSet() {
		return eventSet;
	}

	public void setEventSet(
			java.util.Set<com.jetcms.core.entity.CmsWorkflowEvent> eventSet) {
	...
	public java.util.Set<com.jetcms.core.entity.CmsUser> getCollectUsers() {
		return collectUsers;
	}

	public void setCollectUsers(
			java.util.Set<com.jetcms.core.entity.CmsUser> collectUsers) {
		this.collectUsers = collectUsers;
	}
	

	public java.util.Set<com.jetcms.cms.entity.assist.CmsComment> getComments() {
		return comments;
	}

	public void setComments(
			java.util.Set<com.jetcms.cms.entity.assist.CmsComment> comments) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.cms.entity.main.Content)) return false;
		else {
			com.jetcms.cms.entity.main.Content content = (com.jetcms.cms.entity.main.Content) obj;
	...
	public java.util.List<com.jetcms.cms.entity.main.ContentCatalog> getCatalog() {
		return catalog;
	}

	public void setCatalog(java.util.List<com.jetcms.cms.entity.main.ContentCatalog> catalog) {
	...
	public java.util.List<com.jetcms.cms.entity.main.ContentKj> getKj() {
		return kj;
	}

	public void setKj(java.util.List<com.jetcms.cms.entity.main.ContentKj> kj) {
		this.kj = kj;
	}
