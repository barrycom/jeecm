...
public abstract class BaseCmsVoteSubTopic  implements Serializable {
	...
	public BaseCmsVoteSubTopic (
		Integer id,
		com.jetcms.cms.entity.assist.CmsVoteTopic voteTopic,
		String title,
		Integer type,
		Integer priority) {
	...
	// many to one
	private com.jetcms.cms.entity.assist.CmsVoteTopic voteTopic;

	// collections
	private java.util.Set<com.jetcms.cms.entity.assist.CmsVoteItem> voteItems;
	private java.util.Set<com.jetcms.cms.entity.assist.CmsVoteReply> voteReplys;
	 ...
	 */
	public com.jetcms.cms.entity.assist.CmsVoteTopic getVoteTopic () {
		return voteTopic;
	}
	 ...
	 */
	public void setVoteTopic (com.jetcms.cms.entity.assist.CmsVoteTopic voteTopic) {
	 ...
	 */
	public java.util.Set<com.jetcms.cms.entity.assist.CmsVoteItem> getVoteItems () {
		return voteItems;
	}
	 ...
	 */
	public void setVoteItems (java.util.Set<com.jetcms.cms.entity.assist.CmsVoteItem> voteItems) {
	 ...
	 */
	public java.util.Set<com.jetcms.cms.entity.assist.CmsVoteReply> getVoteReplys () {
		return voteReplys;
	}
	 ...
	 */
	public void setVoteReplys (java.util.Set<com.jetcms.cms.entity.assist.CmsVoteReply> voteReplys) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.cms.entity.assist.CmsVoteSubTopic)) return false;
		else {
			com.jetcms.cms.entity.assist.CmsVoteSubTopic cmsVoteSubTopic = (com.jetcms.cms.entity.assist.CmsVoteSubTopic) obj;
