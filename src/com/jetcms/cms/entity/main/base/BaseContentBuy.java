...
public abstract class BaseContentBuy  implements Serializable {
	...
	private Short orderSta;
	private Short isGave;
	...
	public Short getOrderSta() {
		return orderSta;
	}

	public void setOrderSta(Short orderSta) {
		this.orderSta = orderSta;
	}

	public Short getIsGave() {
		return isGave;
	}

	public void setIsGave(Short isGave) {
		this.isGave = isGave;
	}
