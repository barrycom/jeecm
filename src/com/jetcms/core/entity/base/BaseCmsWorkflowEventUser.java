...
public abstract class BaseCmsWorkflowEventUser  implements Serializable {
	 ...
	 */
	public BaseCmsWorkflowEventUser (Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.core.entity.CmsWorkflowEventUser)) return false;
		else {
			com.jetcms.core.entity.CmsWorkflowEventUser cmsWorkflowEventUser = (com.jetcms.core.entity.CmsWorkflowEventUser) obj;
