...
public interface ContentMng {
	...
	public Pagination getPageByChannelIdsForTag(Integer[] channelIds,
                                                Integer[] typeIds, Boolean titleImg, Boolean recommend,
                                                String title, int open, Integer charge, Map<String, String[]> attr, int orderBy, int option, int pageNo, int pageSize);
	...
	public List<Content> getListByChannelIdsForTag(Integer[] channelIds,
                                                   Integer[] typeIds, Boolean titleImg, Boolean recommend,
                                                   String title, int open, Integer charge, Map<String, String[]> attr, int orderBy, int option, Integer first, Integer count);
	...
	public Pagination getPageByTagIdsForTag(Integer[] tagIds,
                                            Integer[] siteIds, Integer[] channelIds, Integer[] typeIds,
                                            Integer excludeId, Boolean titleImg, Boolean recommend,
                                            String title, int open, Integer charge, Map<String, String[]> attr, int orderBy, int pageNo, int pageSize);
	...
	public Content save(Content bean, ContentExt ext, ContentTxt txt, ContentDoc doc,
                        ...
                        Integer typeId, Boolean draft, Boolean contribute,
                        Short charge, Double chargeAmount,
                        CmsUser user, boolean forMember, String[] catalogNames, String[] cataloglectureDates, String[] catalogstartTimes, String[] catalogendTimes,
                        String[] catalogpaths, String[] cataloglivepaths, String[] cataloglivepasss, String[] catalogpathpasss, Integer[] viewCounts, String[] courseCategorys, String[] catalogids,
                        String[] kjNames, String[] kjpaths, String[] kjpathPasss);
	...
	public Content update(Content bean, ContentExt ext, ContentTxt txt, ContentDoc doc,
                          ...
                          String[] picPaths, String[] picDescs, Map<String, String> attr,
                          Integer channelId, Integer typeId, Boolean draft,
                          Short charge, Double chargeAmount, CmsUser user, boolean forMember, String[] catalogNames,
                          String[] cataloglectureDates, String[] catalogstartTimes, String[] catalogendTimes,
                          String[] catalogpaths, String[] cataloglivepaths, String[] cataloglivepasss, String[] catalogpathpasss, Integer[] viewCounts, String[] courseCategorys, String[] catalogids,
                          String[] kjNames, String[] kjpaths, String[] kjids, String[] kjpathPasss);
