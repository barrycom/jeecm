...
public abstract class BaseContentCheck  implements Serializable {
	...
	private com.jetcms.core.entity.CmsUser reviewer;
	...
	public com.jetcms.core.entity.CmsUser getReviewer() {
		return reviewer;
	}

	public void setReviewer(com.jetcms.core.entity.CmsUser reviewer) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.cms.entity.main.ContentCheck)) return false;
		else {
			com.jetcms.cms.entity.main.ContentCheck contentCheck = (com.jetcms.cms.entity.main.ContentCheck) obj;
