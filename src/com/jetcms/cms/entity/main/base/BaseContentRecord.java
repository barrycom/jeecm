...
public abstract class BaseContentRecord  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.cms.entity.main.ContentRecord)) return false;
		else {
			com.jetcms.cms.entity.main.ContentRecord contentRecord = (com.jetcms.cms.entity.main.ContentRecord) obj;
