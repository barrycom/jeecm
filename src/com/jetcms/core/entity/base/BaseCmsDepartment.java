...
public abstract class BaseCmsDepartment  implements Serializable {
	 ...
	 */
	public BaseCmsDepartment (Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private com.jetcms.core.entity.CmsDepartment parent;

	// collections
	private java.util.Set<com.jetcms.core.entity.CmsDepartment> child;
	...
	private java.util.Set<com.jetcms.cms.entity.assist.CmsGuestbookCtg> guestBookCtgs;
	...
	public com.jetcms.core.entity.CmsDepartment getParent() {
		return parent;
	}

	public void setParent(com.jetcms.core.entity.CmsDepartment parent) {
		this.parent = parent;
	}

	public java.util.Set<com.jetcms.core.entity.CmsDepartment> getChild() {
		return child;
	}

	public void setChild(
			java.util.Set<com.jetcms.core.entity.CmsDepartment> child) {
		this.child = child;
	}
	/**
	...
	public void setControlChannels(
			java.util.Set<com.jetcms.cms.entity.main.Channel> controlChannels) {
	 ...
	 */
	public java.util.Set<com.jetcms.cms.entity.assist.CmsGuestbookCtg> getGuestBookCtgs () {
	 ...
	 */
	public void setGuestBookCtgs (java.util.Set<com.jetcms.cms.entity.assist.CmsGuestbookCtg> guestBookCtgs) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jetcms.core.entity.CmsDepartment)) return false;
		else {
			com.jetcms.core.entity.CmsDepartment cmsDepartment = (com.jetcms.core.entity.CmsDepartment) obj;
